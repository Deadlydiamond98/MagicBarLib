...
public class MagicUpgrade extends MaxMagicModifierItem {
    public MagicUpgrade(Settings settings, int magicIncrement, boolean replenish, int useUntilManaIs, int cooldown) {
