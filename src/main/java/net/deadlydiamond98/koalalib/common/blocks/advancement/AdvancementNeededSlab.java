...
public class AdvancementNeededSlab extends SlabBlock implements IAdvancementNeeded {
    public static final BooleanProperty PLAYERMADE = KoalaLibBlockProperties.PLAYER_MADE_PROPERTY;
    private final String advancementID;

    public AdvancementNeededSlab(Settings settings, Identifier advancementID) {
        this(settings, advancementID.toString());
    }

    public AdvancementNeededSlab(Settings settings, String advancementID) {
        super(settings);
